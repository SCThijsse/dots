...
function M.setup(s)
    ...
    layout:add(volume);      layout:add(separator)
    layout:add(memory);      layout:add(separator)
    layout:add(disk);        layout:add(separator)
    layout:add(cpu);         layout:add(separator)
    layout:add(wifi);        layout:add(separator)
    layout:add(openvpn);     layout:add(separator)
    layout:add(battery);     layout:add(separator)
    layout:add(date);        layout:add(separator)
    layout:add(time);        layout:add(empty_separator)
