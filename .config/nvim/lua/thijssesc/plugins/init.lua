...
require('thijssesc.plugins.colorizer')
require('thijssesc.plugins.dap')
require('thijssesc.plugins.gitsigns')
require('thijssesc.plugins.harpoon')
require('thijssesc.plugins.kommentary')
require('thijssesc.plugins.lsp')
require('thijssesc.plugins.lualine')
require('thijssesc.plugins.neogit')
require('thijssesc.plugins.neoscroll')
require('thijssesc.plugins.nvimtree')
